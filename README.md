...
```
cargo test                                       # 385 tests, fully offline
...
The authoritative test baseline lives in `TASKS.md` (currently **385
passing**: 53 `sim-core` · 275 `solar-sim` · 54 `xtask` lib · 2 xtask smoke ·
